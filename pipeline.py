...
When minimal context is provided give some time to deep thinking.
search the web when asked about something related to the context in the video but is not available in the video
...
"""
    ...
    answer = response.content
    if "I could not find that information" in answer:
        return{
            "answer": answer,
            "timestamps": []
        }
